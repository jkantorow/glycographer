...
def drawBoundingBox(selection="(all)", padding=0.0, linewidth=2.0, r=1.0, g=1.0, b=1.0):     
        ...
        boundingBox = [
                LINEWIDTH, float(linewidth), # type: ignore

                BEGIN, LINES, # type: ignore
                COLOR, float(r), float(g), float(b), # type: ignore

                VERTEX, minX, minY, minZ,       # type: ignore
                VERTEX, minX, minY, maxZ,       # type: ignore

                VERTEX, minX, maxY, minZ,       # type: ignore
                VERTEX, minX, maxY, maxZ,       # type: ignore

                VERTEX, maxX, minY, minZ,       # type: ignore
                VERTEX, maxX, minY, maxZ,       # type: ignore

                VERTEX, maxX, maxY, minZ,       # type: ignore
                VERTEX, maxX, maxY, maxZ,       # type: ignore
